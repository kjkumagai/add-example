...
public class ReversiPanel2 extends JPanel implements MouseListener, Runnable {
	...
	public ReversiPanel2(ConsolPanel consolPanel) {
		...
		firstPlayer = new Player(board, master, "Player 1");
